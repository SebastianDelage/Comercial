    ...
    <>
      ...
      <div className="grid grid-cols-2 gap-2 sm:gap-3 md:grid-cols-3 lg:grid-cols-4">
        ...
        {images.map((image, index) => (
          ...
          <button
            ...
            aria-label={
              `Abrir foto ${index + 1} de ${images.length}`
            }
      ...
      {isOpen &&
        ...
        <div
          ...
          className="fixed inset-0 z-[100] flex touch-none flex-col bg-black/95"
          ...
          >
            ...
            {images.length > 1 && (
              ...
              <button
                ...
                className="absolute left-3 z-20 flex h-14 w-14 items-center justify-center rounded-full bg-white/10 text-4xl text-white transition hover:bg-white/20 sm:left-6"
            ...
            {images.length > 1 && (
              ...
              <button
                ...
                className="absolute right-3 z-20 flex h-14 w-14 items-center justify-center rounded-full bg-white/10 text-4xl text-white transition hover:bg-white/20 sm:right-6"
