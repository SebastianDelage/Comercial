...
export const metadata: Metadata = {
  ...
  description:
    'Conocé la historia de Comercial Rugby Club, sus valores, trayectoria y la comunidad que forma parte de la institución.',
}
        ...
        <div className="grid gap-14 lg:grid-cols-[1fr_1.2fr] lg:items-start">
          ...
          <div className="overflow-hidden rounded-3xl bg-cyan-100">
            ...
            <img
              ...
              alt="Instalaciones y comunidad de Comercial Rugby Club"
              loading="lazy"
